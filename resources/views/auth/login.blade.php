...
<div class="login">
    <div class="log">
        <img src="{{asset('assets/img/—Pngtree—a man shopping with cart_6666683.png')}}" alt="">
    </div>
    <div class="logForm">
        <center>
...
<br>     
              <a href="register.html">Do you have account?</a>
              <br><br>
            <center>
                <button class="bn632-hover bn27" type="submit">Login</button>
            </center>
        </form>
