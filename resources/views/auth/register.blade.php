...
<div class="register">
    <div class="reg">
        <center><h2>Welcome To EasyMart</h2></center>
        <br><br>
...
<br>
          <a href="login.html">Have you already register?</a>
<br><br>
        <center>
            <button class="bn632-hover bn27" type="submit">Register</button>
        </center>
    </form>
</div>

<div class="log">
    <img src="{{asset('assets/img/—Pngtree—young man with shopping cart_7579695.png')}}" alt="">
</div>
